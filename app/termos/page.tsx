      ...
      <div style={{ maxWidth: 460, margin: "0 auto", padding: "14px 16px 48px" }}>
        ...
        <Sec n="5" t="Ippon Pro (assinatura)">
          ...
          <Lista itens={[
            ...
            "Após o período gratuito, a subscrição é mensal e renova-se automaticamente todos os meses, até ser cancelada.",
            "Podes cancelar quando quiseres: manténs o acesso até ao fim do mês já pago e não há nova renovação.",
            "O cancelamento não dá direito a reembolso do mês em curso.",
            "Os preços podem ser alterados; qualquer alteração é comunicada com antecedência e só se aplica a partir da renovação seguinte.",
          ]} />
        </Sec>

...
//   - MOLDURA: tabela chave_atletas (pools A/B/C/D com id_person por ordem)
...
//
// Devolve: { ok, comp, cat, genero, existeMoldura, chave, atualizado_em }
// Se não houver moldura para a categoria, existeMoldura=false (a página mostra
...
export async function GET(req: Request) {
  ...
  if (!linha || !linha.pools) {
    return NextResponse.json({
      ok: true, comp, cat, genero: null, existeMoldura: false, chave: null,
  ...
  let byes: MolduraCategoria["byes"] | undefined;

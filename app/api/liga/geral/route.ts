...
// tal como o /api/resultados no modo por_atleta, o congelar.ts e o /api/liga.
//
...
// ja lutaram. Foi o que pos uma equipa a 107 no Meu Time e a 0 no ranking, na
// competicao 1746 - e o que fazia o pontos_geral somar a menos enquanto a
// rodada decorria, saltando para o valor certo so no congelamento.
// ---------------------------------------------------------------------------

// O ranking refresca ao vivo e varios membros escalam os mesmos atletas.
// Cache curta, por instancia, para nao repetir idas ao JudoBase a cada tick.

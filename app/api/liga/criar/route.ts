...
export async function POST(req: Request) {
  ...
  // LIMITE: uma só verificação, do formato que está a criar. Antes havia duas
  // (uma para "criadas", outra para "participações") com números diferentes —
  // e nenhuma distinguia liga de mata-mata.
  const bloqueio = await bloqueioPorLimite(user_id, formato === "copa");
  if (bloqueio) {

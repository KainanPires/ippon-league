...
export const NOTIF: Record<string, Entrada> = {
  ...
  "subscricao.terminouCorpo": {
    ...
    en: "Your Pro access has ended. Your account, team and history are kept. Until you go Pro again: your points in the World and Continental leagues were reset and you've left them; if you were in a Copa do Dôdo, you've been eliminated; and if you have more friend leagues than the free limit, the app will ask you to choose which to keep.",
  ...
  "subscricao.pagamentoFalhouCorpo": {
    ...
    en: "The payment didn't go through. You still have access and we'll try again over the next few days — if your card changed, update it in your profile. If it isn't resolved and you lose Pro, your points in the World and Continental leagues reset and you leave the Copa do Dôdo.",
  ...
  "dodo.conviteCorpo": {
    ...
    en: "You're Pro, so you can enter the Copa do Dôdo — the worldwide knockout between continents. {dias} days left before entries close. It's not first-come, first-served: it's a draw for spots by continent, and entering today or on the last day gives you exactly the same chance. It doesn't affect your other leagues. Tap to enter.",
  ...
  "dodo.conviteHojeTitulo": {
    ...
    en: "🚨 Last day for the Copa do Dôdo #{numero}",
  ...
  "dodo.conviteHojeCorpo": {
    ...
    en: "Entries for the Copa do Dôdo close today. You're Pro and still in time — it's a draw for spots by continent and it doesn't affect your other leagues. Tap to enter before the draw.",
